import type CarouselTypes from '#build/pohon/carousel';
import type { DeepPartial } from '@vinicunca/perkakas';

// @unocss-include

export const carouselTheme: DeepPartial<typeof CarouselTypes> = {
  slots: {
    ...
    dot: 'cursor-pointer size-3 bg-(--ui-border-accented) rounded-full transition'
  },
  variants: {
    orientation: {
      vertical: {
