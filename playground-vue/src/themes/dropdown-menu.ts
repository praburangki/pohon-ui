import type DropdownMenuTypes from '#build/pohon/dropdown-menu';
import type { DeepPartial } from '@vinicunca/perkakas';

// @unocss-include

export function getDropdownMenuTheme(colors: Array<string>): DeepPartial<typeof DropdownMenuTypes> {
  return {
    slots: {
