import type BreadcrumbTypes from '#build/pohon/breadcrumb';
import type { DeepPartial } from '@vinicunca/perkakas';

// @unocss-include

export const breadcrumbTheme: DeepPartial<typeof BreadcrumbTypes> = {
  slots: {
  ...
  compoundVariants: [
    {
      ...
      to: true,
      class: {
        link: 'hover:text-(--ui-text) transition-colors',
      },
    },
  ],
};
